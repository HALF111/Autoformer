...
for test_train_num in 1000
do
for adapted_lr_times in 5 10 20 50
do
python -u run.py   --is_training 1   --root_path ./dataset/weather/   --data_path weather.csv   --model_id weather_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 21   --dec_in 21   --c_out 21   --des 'Exp'   --itr 1   --gpu $gpu_num  --test_train_num $test_train_num  --adapted_lr_times $adapted_lr_times --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
done
done
done
done
