...
# do
# for test_train_epochs in 2 3 5
# do
# # adapted_lr_times=$(echo "$adapted_lr_times*$test_train_num"|bc)

# python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --model_id ETTh1_96_$pred_len   --model Autoformer   --data ETTh1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --test_train_epochs $test_train_epochs --run_adapt > $cur_path'/'ttn$test_train_num'_'epochs$test_train_epochs'_'lr$adapted_lr_times'_'batch1.log
# done
# done
# done
# done
...
python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --test_train_epochs $test_train_epochs --run_adapt > $cur_path'/'ttn$test_train_num'_'epochs$test_train_epochs'_'lr$adapted_lr_times'_'batch1.log
done
done
done
done
