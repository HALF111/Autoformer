...
dir_name=all_result_select_with_distance
...
# # run train and test first
python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --model_id ETTh2_96_$pred_len   --model Autoformer   --data ETTh2   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --run_train --run_test > $cur_path'/'train_and_test_loss.log
# only run  test first
# python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --model_id ETTh2_96_$pred_len   --model Autoformer   --data ETTh2   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --run_test > $cur_path'/'test_loss.log

for selected_data_num in 10
do
for test_train_num in 100 200
do
# for adapted_lr_times in 0.5 2 5 20
for adapted_lr_times in 2 5 20
do

python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --model_id ETTh2_96_$pred_len   --model Autoformer   --data ETTh2   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
done
done
done
done
...
# do
# python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times  --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
...
# python -u run.py   --is_training 1   --root_path ./dataset/illness/   --data_path national_illness.csv   --model_id ili_36_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 36   --label_len 18   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num   --run_test > $cur_path'/'test_loss.log
# python -u run.py   --is_training 1   --root_path ./dataset/illness/   --data_path national_illness.csv   --model_id ili_36_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 36   --label_len 18   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num   --run_test_batchsize1 > $cur_path'/'test_batchsize1_loss.log

# # for selected_data_num in 10
# for selected_data_num in 30
# do
# # for test_train_num in 100 200
# for test_train_num in 200
# do
# for adapted_lr_times in 2 5 20 50
# do
# python -u run.py   --is_training 1   --root_path ./dataset/illness/   --data_path national_illness.csv   --model_id ili_36_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 36   --label_len 18   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num  --test_train_num $test_train_num  --adapted_lr_times $adapted_lr_times  --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
