...
# 5.BTC_Price_hour_pct数据集
# 5.1 pred_len=96
for pred_len in 96
# for pred_len in 192 336 720
do
name=BTC_Price_hour_pct
cur_path=./$dir_name/$name'_'pl$pred_len
if [ ! -d $cur_path ]; then
    mkdir $cur_path
fi
# run train and test first
python -u run.py   --is_training 1   --root_path ./dataset/My_BTC_data/   --data_path BTC_Price_hour_pct.csv   --model_id BTC_Price_hour_pct_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 5   --dec_in 5   --c_out 5   --des 'Exp'   --itr 1   --gpu $gpu_num  --run_train --run_test > $cur_path'/'train_and_test_loss.log
# only run  test first
# python -u run.py   --is_training 1   --root_path ./dataset/My_BTC_data/   --data_path BTC_Price_hour_pct.csv   --model_id BTC_Price_hour_pct_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 5   --dec_in 5   --c_out 5   --des 'Exp'   --itr 1   --gpu $gpu_num  --run_test > $cur_path'/'test_loss.log
...
python -u run.py   --is_training 1   --root_path ./dataset/My_BTC_data/   --data_path BTC_Price_hour_pct.csv   --model_id BTC_Price_hour_pct_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 5   --dec_in 5   --c_out 5   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --lambda_reg $lambda_reg --alpha $alpha --run_calc > $cur_path'/'alpha$alpha'_'ttn$test_train_num'_'lambda$lambda_reg.log
done
done
done
done
