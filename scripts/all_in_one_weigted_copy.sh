...
# for get_grads_from in val
# do
# # for test_train_num in 10 50
# for test_train_num in 50
# do
# # python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --model_id ETTh1_96_$pred_len   --model Autoformer   --data ETTh1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --lambda_reg $lambda_reg --run_get_grads --get_grads_from $get_grads_from > $cur_path'/'grads_$get_grads_from'_'ttn$test_train_num.log

# for lambda_reg in 5000 10000 20000 100000
# do

# python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --model_id ETTh1_96_$pred_len   --model Autoformer   --data ETTh1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --lambda_reg $lambda_reg --run_calc --get_grads_from $get_grads_from > $cur_path'/'$get_grads_from'_'ttn$test_train_num'_'lambda$lambda_reg.log
# done
# done
# done
# done
...
for get_grads_from in val test
do
# for test_train_num in 10 50
for test_train_num in 20
do
python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --run_get_grads --get_grads_from $get_grads_from > $cur_path'/'grads_$get_grads_from'_'ttn$test_train_num.log
for lambda_reg in 1000 10000 100000
do
python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --lambda_reg $lambda_reg --run_calc --get_grads_from $get_grads_from > $cur_path'/'$get_grads_from'_'ttn$test_train_num'_'lambda$lambda_reg.log
done
done
done
done
...
# for lambda_reg in 100000000 1000000000
# do
