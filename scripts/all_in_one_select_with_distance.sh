...
# python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --model_id ETTh1_96_$pred_len   --model Autoformer   --data ETTh1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
...
do
for test_train_num in 500 1000
do
for adapted_lr_times in 0.5 2 5 20
do
python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTm1.csv   --model_id ETTm1_96_$pred_len   --model Autoformer   --data ETTm1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
done
done
done
done
...
# do
# python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTm2.csv   --model_id ETTm2_96_$pred_len   --model Autoformer   --data ETTm2   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
...
# for selected_data_num in 10
# do
# for test_train_num in 100 300
# do
# for adapted_lr_times in 2 5 20 50
# do
# python -u run.py   --is_training 1   --root_path ./dataset/exchange_rate/   --data_path exchange_rate.csv   --model_id Exchange_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 8   --dec_in 8   --c_out 8   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_select_with_distance  --selected_data_num $selected_data_num > $cur_path'/'selected$selected_data_num'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
