...
# fi
# # run train and test first
# python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features S   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 1   --dec_in 1   --c_out 1   --des 'Exp'   --itr 1   --gpu $gpu_num --run_train --run_test > $cur_path'/'train_and_test_loss.log
...
# do
# python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features S   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 1   --dec_in 1   --c_out 1   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
# done
# done
# done
...
do
python -u run.py   --is_training 1   --root_path ./dataset/weather/   --data_path weather.csv   --model_id weather_96_$pred_len   --model Autoformer   --data custom   --features S   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 1   --dec_in 1   --c_out 1   --des 'Exp'   --itr 1   --train_epochs 2   --gpu $gpu_num  --test_train_num $test_train_num  --adapted_lr_times $adapted_lr_times --run_adapt > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
done
done
done
...
# fi
# # # run train and test first
# # python -u run.py   --is_training 1   --root_path ./dataset/traffic/   --data_path traffic.csv   --model_id traffic_96_$pred_len   --model Autoformer   --data custom   --features MS   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 862   --dec_in 862   --c_out 1   --des 'Exp'   --itr 1   --train_epochs 3   --gpu $gpu_num  --run_train --run_test > $cur_path'/'train_and_test_loss.log
# # run only test first
# # python -u run.py   --is_training 1   --root_path ./dataset/traffic/   --data_path traffic.csv   --model_id traffic_96_$pred_len   --model Autoformer   --data custom   --features MS   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 862   --dec_in 862   --c_out 1   --des 'Exp'   --itr 1   --train_epochs 3   --gpu $gpu_num  --run_test > $cur_path'/'test_loss.log
...
# for adapted_lr_times in 1 5 20 100
# do
# python -u run.py   --is_training 1   --root_path ./dataset/traffic/   --data_path traffic.csv   --model_id traffic_96_$pred_len   --model Autoformer   --data custom   --features MS   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 862   --dec_in 862   --c_out 1   --des 'Exp'   --itr 1   --train_epochs 3   --gpu $gpu_num  --test_train_num $test_train_num   --adapted_lr_times $adapted_lr_times --run_adapt > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
# done
# done
# done
