...
# for adapt_start_pos in 1 10 30 80
for adapt_start_pos in 48
do
for test_train_num in 10
do
for adapted_lr_times in 50 100 200
do
python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt  --use_nearest_data --adapt_start_pos $adapt_start_pos > $cur_path'/'startpos$adapt_start_pos'_'ttn$test_train_num'_'lr$adapted_lr_times.log
done
done
done
done
