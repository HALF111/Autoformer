...
dir_name=all_result_use_further
...
# # for adapt_start_pos in 1 10 30 80
# for adapt_start_pos in 96 106 118 130 142
# do
# for test_train_num in 4
# do
# for adapted_lr_times in 200 500 1000
# do
# python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt  --use_further_data --adapt_start_pos $adapt_start_pos > $cur_path'/'startpos$adapt_start_pos'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
...
for adapt_start_pos in 138 282
do
for test_train_num in 12
do
for adapted_lr_times in 5 10 20 50
do
python -u run.py   --is_training 1   --root_path ./dataset/weather/   --data_path weather.csv   --model_id weather_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 21   --dec_in 21   --c_out 21   --des 'Exp'   --itr 1   --gpu $gpu_num  --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt  --use_further_data --adapt_start_pos $adapt_start_pos > $cur_path'/'startpos$adapt_start_pos'_'ttn$test_train_num'_'lr$adapted_lr_times.log
done
done
done
done
...
# for adapt_start_pos in 52 72 104 156
# do
# for test_train_num in 10
# do
# # for adapted_lr_times in 0.5 2 5 20
# # for adapted_lr_times in 50 100 200 500
# for adapted_lr_times in 0.5 2 5 20 50
# do
# python -u run.py   --is_training 1   --root_path ./dataset/illness/   --data_path national_illness.csv   --model_id ili_36_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 36   --label_len 18   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num  --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt  --use_further_data --adapt_start_pos $adapt_start_pos > $cur_path'/'startpos$adapt_start_pos'_'ttn$test_train_num'_'lr$adapted_lr_times.log
# done
# done
# done
# done
