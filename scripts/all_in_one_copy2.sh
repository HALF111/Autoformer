...
# for test_train_num in 5 10
# do
# for adapted_lr_times in 2000
# do
...
# for test_train_num in 20 30
# do
# for adapted_lr_times in 2000 5000 10000
# do
# # adapted_lr_times=$(echo "$adapted_lr_times*$test_train_num"|bc)
...
python -u run.py   --is_training 1   --root_path ./dataset/exchange_rate/   --data_path exchange_rate.csv   --model_id Exchange_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 8   --dec_in 8   --c_out 8   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
done
done
done
...
# for test_train_num in 1 10 20 30
# do
