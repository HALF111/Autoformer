...
# do
# # for lambda_reg in 10000 100000 1000000 1000000
# for lambda_reg in 10000
# do
# python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num  --lambda_reg $lambda_reg --run_calc > $cur_path'/'ttn$test_train_num'_'lambda$lambda_reg'_'batch1.log
# done
# done
# done
