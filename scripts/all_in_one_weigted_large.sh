...
for get_grads_from in test val
do
for test_train_num in 10 50
# for test_train_num in 50
do
adapted_degree=large
python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --model_id ETTh1_96_$pred_len   --model Autoformer   --data ETTh1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --run_get_grads --get_grads_from $get_grads_from --adapted_degree $adapted_degree > $cur_path'/'grads_$get_grads_from'_'$adapted_degree'_'ttn$test_train_num.log
...
# for test_train_num in 10 50
# do
# python -u run.py   --is_training 1   --root_path ./dataset/exchange_rate/   --data_path exchange_rate.csv   --model_id Exchange_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 8   --dec_in 8   --c_out 8   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num  --run_get_grads --get_grads_from $get_grads_from > $cur_path'/'grads_$get_grads_from'_'ttn$test_train_num.log
# for lambda_reg in 1000 10000 100000
# do
# python -u run.py   --is_training 1   --root_path ./dataset/exchange_rate/   --data_path exchange_rate.csv   --model_id Exchange_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 8   --dec_in 8   --c_out 8   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num  --lambda_reg $lambda_reg --run_calc --get_grads_from $get_grads_from > $cur_path'/'$get_grads_from'_'ttn$test_train_num'_'lambda$lambda_reg.log
# done
# done
# done
# done
...
# for test_train_num in 10 50
# do
# python -u run.py   --is_training 1   --root_path ./dataset/traffic/   --data_path traffic.csv   --model_id traffic_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 862   --dec_in 862   --c_out 862   --des 'Exp'   --itr 1   --train_epochs 3   --gpu $gpu_num  --test_train_num $test_train_num  --run_get_grads --get_grads_from $get_grads_from > $cur_path'/'grads_$get_grads_from'_'ttn$test_train_num.log
# for lambda_reg in 1000 10000 100000
# do
# python -u run.py   --is_training 1   --root_path ./dataset/traffic/   --data_path traffic.csv   --model_id traffic_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 862   --dec_in 862   --c_out 862   --des 'Exp'   --itr 1   --train_epochs 3   --gpu $gpu_num  --test_train_num $test_train_num   --lambda_reg $lambda_reg --run_calc --get_grads_from $get_grads_from > $cur_path'/'$get_grads_from'_'ttn$test_train_num'_'lambda$lambda_reg.log
# done
# done
# done
# done
