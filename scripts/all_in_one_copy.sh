...
# do
# python -u run.py   --is_training 1   --root_path ./dataset/ETT-small/   --data_path ETTh1.csv   --model_id ETTh1_96_$pred_len   --model Autoformer   --data ETTh1   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 7   --dec_in 7   --c_out 7   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
# done
# done
# done
...
# for test_train_num in 5 10 15 20
# do
# # for adapted_lr_times in 0.5 1 3 5
# for adapted_lr_times in 10 20 50
# do
...
do
for adapted_lr_times in 2000 5000 10000 15000
# for adapted_lr_times in 0.5 2 5 20
do
python -u run.py  --is_training 1   --root_path ./dataset/electricity/   --data_path electricity.csv   --model_id ECL_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3  --enc_in 321   --dec_in 321   --c_out 321   --des 'Exp'   --itr 1   --gpu $gpu_num --test_train_num $test_train_num --adapted_lr_times $adapted_lr_times --run_adapt > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
done
done
done
...
# do
# # for adapted_lr_times in 100 200 300
# # for adapted_lr_times in 200 500 1000
# for adapted_lr_times in 50 100
# do
...
# # run only test first
# python -u run.py   --is_training 1   --root_path ./dataset/weather/   --data_path weather.csv   --model_id weather_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 21   --dec_in 21   --c_out 21   --des 'Exp'   --itr 1   --train_epochs 2   --gpu $gpu_num --run_test > $cur_path'/'test_loss.log
...
# do
# python -u run.py   --is_training 1   --root_path ./dataset/traffic/   --data_path traffic.csv   --model_id traffic_96_$pred_len   --model Autoformer   --data custom   --features M   --seq_len 96   --label_len 48   --pred_len $pred_len   --e_layers 2   --d_layers 1   --factor 3   --enc_in 862   --dec_in 862   --c_out 862   --des 'Exp'   --itr 1   --train_epochs 3   --gpu $gpu_num  --test_train_num $test_train_num   --adapted_lr_times $adapted_lr_times > $cur_path'/'ttn$test_train_num'_'lr$adapted_lr_times'_'batch1.log
# done
# done
# done
...
# do
# # for adapted_lr_times in 5000 10000 12000 15000 20000 30000 50000
# for adapted_lr_times in 2000 3000 4000
# do
